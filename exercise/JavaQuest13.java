public class JavaQuest13 {
  ...
  public static double convertKelvin(double dou) {
    double kelvin = dou + 273.15d;
    return kelvin;
  }

  // Fahrenheit (華氏) = Celsius (攝氏) * 1.80 + 32.00
  public static double convertFahrenheit(double dou) {
    double Fahrenheit = dou * 1.80d + 32.00d;
    return Fahrenheit;
