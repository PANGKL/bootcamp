...
public class Person implements Player {
  ...
  public Person() {
    this.pockets = new Pocket[] {new Pocket(), new Pocket()};
  }
  ...
  public static void main(String[] args) {
    ...
    System.out
        .println("p1 Left Pocket details = " + p1.getLeftPocket().toString());
    System.out
        .println("p1 Right Pocket details = " + p1.getRightPocket().toString());
